...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="POST">
                    <input type="submit" class="btn" name="buy_hpkey" value="Buy Now"><br><br>
                </form>
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_hpkey'])){echo "Item added to cart!";} ?></h4>  
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="CosmicByte.php"><img src="../images/cosmic.png"></a>
                <h4>Cosmic Byte</h4>
                <p>Rs 1,284</p>
            </div>
            <!-- Product 2  -->
            <div class="col-4">
                <a href="redgear.php"><img src="../images/redgear.png"></a>
                <h4>Redgear G-20</h4>
                <p>Rs 1,143</p>
            </div>
            <!-- Product 3  -->
            <div class="col-4">
                <a href="zebronics.php"><img src="../images/zebronics.png"></a>   
                <h4>Zebronics</h4>
                <p>Rs 1,500</p>
            </div>
        </div>
