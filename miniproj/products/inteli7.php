...
<head>
    ...
    <link rel="stylesheet" href="products.css?ver=<?php echo rand(111,999)?>">
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/inteli7.png">
            </div>
            <div class="col-2">
                <p><a href="../MiniProject.html">Home</a> / <a href="../ProductOp.html">Products</a> / <a href="../ProcessorProductLine.html">Processors</a></p>
                <h1>Intel i7</h1>
                Price :- <h4>Rs 25,000</h4>
                ...
                <br>
                <form method="POST">
                    <input type="submit" class="btn" name="buy_i7" value="Buy Now"><br><br>    
                </form>   
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_i7'])){echo "Item added to cart!";} ?></h4>       
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="inteli5.html"><img src="../images/inteli5.png"></a>
                <h4>Intel i5</h4>
                <p>Rs 16,000</p>
            </div>
            <!-- Product 2  -->
            <div class="col-4">
                <a href="ryzen5.html"><img src="../images/amd5.png"></a>
                <h4>AMD Ryzen 5</h4>
                <p>Rs 12,900</p>
            </div>
            <!-- Product 3  -->
            <div class="col-4">
                <a href="ryzen7.html"><img src="../images/amd7.png"></a>   
                <h4>AMD Ryzen 7</h4>
                <p>Rs 15,500</p>
            </div>
        </div>
