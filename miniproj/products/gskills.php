...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_gskills" value="Buy Now"><br><br>
                </form>    
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_gskills'])){echo "Item added to cart!";} ?></h4>              
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="corsair.html"><img src="../images/corsair.jpg"></a>
            ...
            <!-- Product 3  -->
            <div class="col-4">
                <a href="ballistix.html"><img src="../images/ballistix.png"></a>   
                <h4>Ballistix Crucial 8GB</h4>
                <p>Rs 4,315</p>
            </div>
        </div>
    </div>
