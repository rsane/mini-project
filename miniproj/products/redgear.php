...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/redgear.jpg">
            </div>
            <div class="col-2">
                <p><a href="../MiniProject.html">Home</a> / <a href="../ProductOp.html">Products</a> / <a href="../KeyboardProductLine.html">Keyboard</a></p>
                <h1>Redgear G - 20 Keyboard</h1>
                Price :- <h4>Rs 1,143</h4>
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_redgear" value="Buy Now"><br><br>
                </form>    
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_redgear'])){echo "Item added to cart!";} ?></h4>                
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="CosmicByte.html"><img src="../images/cosmic.png"></a>
                <h4>Cosmic Byte Keyboard</h4>
                <p>Rs 1,284</p>
            </div>
            <!-- Product 2  -->
            <div class="col-4">
                <a href="zebronics.html"><img src="../images/zebronics.jpg"></a>
                <h4>Zebronics</h4>
                <p>Rs 1,500</p>
            </div>
            <!-- Product 3  -->
            <div class="col-4">
                <a href="hpkey.html"><img src="../images/HPkey.jpg"></a>   
                <h4>HP GH100</h4>
                <p>Rs 1,780</p>
            </div>
        </div>
