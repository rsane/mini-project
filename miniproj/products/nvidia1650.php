...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_nvidia1650" value="Buy Now"><br><br>
                </form> 
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_nvidia1650'])){echo "Item added to cart!";} ?></h4>                   
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <!-- Product 2  -->
            <div class="col-4">
                <a href="msirtx.html"><img src="../images/msi30.jpg"></a>
                <h4>MSI RTX 3060</h4>
                <p>Rs 69,999</p>
            </div>
            <!-- Product 3  -->
