    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_i5" value="Buy Now"><br><br>
                </form>  
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_i5'])){echo "Item added to cart!";} ?></h4>              
            </div>
        </div>
    </div>
