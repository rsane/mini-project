...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_ryzen5" value="Buy Now"><br><br>
                </form>   
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_ryzen5'])){echo "Item added to cart!";} ?></h4>                      
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <!-- Product 2  -->
            <div class="col-4">
                <a href="inteli7.html"><img src="../images/inteli7.png"></a>
                <h4>Intel i7</h4>
                <p>Rs 25,500</p>
            </div>
            <!-- Product 3  -->
