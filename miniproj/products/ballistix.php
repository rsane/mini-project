...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/ballistix.png">
            </div>
            <div class="col-2">
                <p><a href="../MiniProject.html">Home</a> / <a href="../ProductOp.html">Products</a> / <a href="../RamProductLine.html">RAM Cards</a></p>
                <h1>Ballistix Crucial 8GB</h1>
                Price :- <h4>Rs 4,315</h4>
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_ballistix" value="Buy Now"><br><br>
                </form>    
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_ballistix'])){echo "Item added to cart!";} ?></h4>              
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="gskills.html"><img src="../images/gskills.png"></a>
                <h4>G.Skills Ripjaws 8GB</h4>
                <p>Rs 4,399</p>
            </div>
            <!-- Product 2  -->
            <div class="col-4">
                <a href="corsair.html"><img src="../images/corsair.png"></a>
                <h4>Corsair Vengence 8GB</h4>
                <p>Rs 4,500</p>
            </div>
            <!-- Product 3  -->
            <div class="col-4">
                <a href="hyperx.html"><img src="../images/hyperx.png"></a>   
                <h4>HyperX Fury 8GB</h4>
                <p>Rs 4,487</p>
            </div>
        </div>
    </div>
