...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_zebronics" value="Buy Now"><br><br>
                </form>        
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_zebronics'])){echo "Item added to cart!";} ?></h4>                 
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <!-- Product 2  -->
            <div class="col-4">
                <a href="redgear.html"><img src="../images/redgear.jpg"></a>
                <h4>Redgear G-20</h4>
                <p>Rs 1,143</p>
            </div>
            <!-- Product 3  -->
