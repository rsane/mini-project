    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <h1>Cosmic Byte Keyboard</h1>
                Price :- <h4>Rs 1,284</h4>
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_cosmic" value="Buy Now"><br><br>
                </form>     
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_cosmic'])){echo "Item added to cart!";} ?></h4>             
            </div>
        </div>
    </div>
