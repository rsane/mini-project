...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <br>
                <form method="post">
                    <input type="submit" class="btn" name="buy_redragon" value="Buy Now"><br><br>
                </form> 
                <h4 class="msg" id="msg_show"><?php if(isset($_POST['buy_redragon'])){echo "Item added to cart!";} ?></h4>                   
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <!-- Product 1  -->
            <div class="col-4">
                <a href="lenovo.html"><img src="../images/lenovo.png"></a>
                <h4>Lenovo Legion</h4>
                <p>Rs 1,159</p>
            </div>
            <!-- Product 2  -->
